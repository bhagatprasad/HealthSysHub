...
USING (
    VALUES 
        ...
        ('Pediatric Infectious Disease', 'Infectious diseases affecting children'),
        ('Pediatric Allergy', 'Allergic conditions in children'),
        ('Pediatric Endocrinology', 'Hormonal disorders in children'),
        ('Pediatric Neurology', 'Nervous system disorders in children'),
        ('Pediatric Hematology', 'Blood disorders in children'),
        ('Pediatric Oncology', 'Cancer treatment for children'),
        ('Pediatric Rheumatology', 'Joint disorders in children'),
        ('Pediatric Pulmonology', 'Respiratory disorders in children'),
        ('Pediatric Urology', 'Urinary tract disorders in children'),
        ('Pediatric Gastroenterology', 'Digestive disorders in children'),
        ('Pediatric Surgery', 'Surgical care for children'),
        ('Pediatric Psychiatry', 'Mental health care for children'),
        ('Pediatric Anesthesiology', 'Anesthesia for pediatric patients'),
        ('Pediatric Radiology', 'Imaging services for children'),
        ('Pediatric Pathology', 'Laboratory analysis for pediatric diseases'),
        ('Pediatric Emergency Medicine', 'Emergency care for pediatric patients'),
        ('Pediatric Critical Care', 'Intensive care for critically ill children'),
        ('Pediatric Cardiac Surgery', 'Heart surgery for children'),
        ('Pediatric Nephrology', 'Kidney care for children'),
        ('Pediatric Gastrointestinal Surgery', 'Surgery for digestive issues in children'),
        ('Pediatric Otolaryngology', 'ENT care for children'),
        ('Pediatric Plastic Surgery', 'Cosmetic and reconstructive surgery for children'),
        ('Pediatric Sports Medicine', 'Sports injuries in children'),
        ('Pediatric Sleep Medicine', 'Sleep issues in children'),
